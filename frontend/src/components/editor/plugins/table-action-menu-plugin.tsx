...
import { type JSX, type ReactPortal, useCallback, useEffect, useRef, useState } from "react";
...
function TableActionMenu({
  ...
  if (cellMerge) {
    if (canMergeCells) {
      mergeCellButton = (
        <CommandItem onSelect={() => mergeTableCellsAtSelection()}>Merge cells</CommandItem>
      );
    } else if (canUnmergeCell) {
      mergeCellButton = (
        <CommandItem onSelect={() => unmergeTableCellsAtSelection()}>Unmerge cells</CommandItem>
      );
    }
  }
