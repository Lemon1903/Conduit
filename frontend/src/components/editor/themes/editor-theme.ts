...
export const editorTheme: EditorThemeClasses = {
  ...
  quote: "mt-6 border-l-2 pl-4 md:pl-6 italic",
  link: "text-blue-600 hover:underline hover:cursor-pointer",
  list: {
    checklist: "relative",
    listitem: "mx-6 md:mx-8",
    listitemChecked:
    ...
    ol: "my-6 ml-4 md:ml-6 list-decimal [&>li]:mt-2",
    olDepth: [
  ...
  tableCell:
    'EditorTheme__tableCell w-24 relative border !p-0 !px-4 !py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right"',
